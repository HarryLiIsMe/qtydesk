...
void DeviceInfo::setPassword(const QString &pass){
    m_tempPass =  pass ;
}
void  DeviceInfo::setRemoteDeviceID(QString remoteDeviceID){
    this->m_remoteDeviceID= remoteDeviceID;
}
QString DeviceInfo::getRemoteHost() {
    return this->m_remoteHost ;
}
QString DeviceInfo::getTempPass() {
    return this->m_tempPass ;
}
quint16 DeviceInfo::getRemotePort() {
    return this->m_remotePort ;
}
QString DeviceInfo::getRemoteDeviceID(){
