...
void Log4j::userLog(int conOrFile){
...
void Log4j::messageOutputConsole(QtMsgType type, const QMessageLogContext &context, const QString &msg){
    int msgLevel = 0;
...
void Log4j::messageOutputToFile(QtMsgType type, const QMessageLogContext &context, const QString &msg){
    QString formatMsg = qFormatLogMessage( type, context, msg );
    QFile file ;
